...
@section('content')
    ...
    <form action="{{ route('admin.system_prices.update', $systemPrice) }}" method="POST" class="bg-white p-6 rounded shadow max-w-xl">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="value" id="value" value="{{ old('value', $systemPrice->value) }}"
                   class="mt-1 w-full border border-gray-300 rounded p-2" required>
        </div>
