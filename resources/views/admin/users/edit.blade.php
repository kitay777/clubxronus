...
@section('content')
    ...
    <div class="mt-6 flex gap-4">
        <a href="{{ route('admin.users.karte.edit', $user) }}" class="px-4 py-2 bg-gray-700 text-white rounded">
            カルテを見る
        </a>

        <a href="{{ route('admin.users.visits.index', $user) }}" class="px-4 py-2 bg-gray-700 text-white rounded">
            来店履歴
        </a>
    </div>
